...
class UserPredictions extends Component{
  ...
  state = {
    ...
    fetchUserPredictions = (userId) => {
        ...
        if(userId != null){
         var requestOptions = {
          ...
          fetch("https://18.219.229.84/v1/iplt20/getPredictions?userId="+userId, requestOptions)
    ...
    getUserPredictions = async (userId) => {
        ...
        //const proxyurl = "https://cors-anywhere.herokuapp.com/";
        const url = "https://18.219.229.84/v1/iplt20/getPredictions?userId="+currentUserEmail;
