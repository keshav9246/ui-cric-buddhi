...
class UserPredictions extends Component{
  ...
  state = {
    ...
    fetchUserPredictions = (userId) => {
        ...
        if(userId != null){
         var requestOptions = {
          ...
          fetch("https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/getPredictions?userId="+userId, requestOptions)
    ...
    getUserPredictions = async (userId) => {
        ...
        //const proxyurl = "https://cors-anywhere.herokuapp.com/";
        const url = "https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/getPredictions?userId="+currentUserEmail;
