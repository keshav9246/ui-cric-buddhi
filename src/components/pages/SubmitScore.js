...
class SubmitScore extends Component {
    ...
    getPlaying11 = () => {
        ...
        fetch(`https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/getPlaying11?gameNum=${this.state.selectedGame}`, requestOptions)
    ...
    handleSubmit= (event) => {
        ...
        var requestOptions = {
          ...
          fetch(`https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/submitScore`, requestOptions)
          .then(response => response.text())
