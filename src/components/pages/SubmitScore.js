...
class SubmitScore extends Component {
    ...
    getPlaying11 = () => {
        ...
        fetch(`https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/getPlaying11?gameNum=${this.state.selectedGame}`, requestOptions)
    ...
    handleSubmit= (event) => {
        ...
        var requestOptions = {
          ...
          fetch(`https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/submitScore`, requestOptions)
          .then(response => response.text())
