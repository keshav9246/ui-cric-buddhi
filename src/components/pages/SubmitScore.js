...
class SubmitScore extends Component {
    ...
    getPlaying11 = () => {
        ...
        fetch(`https://18.219.229.84/v1/iplt20/getPlaying11?gameNum=${this.state.selectedGame}`, requestOptions)
    ...
    handleSubmit= (event) => {
        ...
        var requestOptions = {
          ...
          fetch(`https://18.219.229.84/v1/iplt20/submitScore`, requestOptions)
          .then(response => response.text())
