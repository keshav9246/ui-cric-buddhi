  ...
  state = {
    ...
    getAssignments = () => {
        var requestOptions = {
          ...
          fetch( "https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/assignments", requestOptions)
    ...
    getAllocationsByGame = (game) => {
        var requestOptions = {
          ...
          fetch( "https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/getAssignments?gameNum="+game, requestOptions)
            .then(response => response.text())
            .then(result => {result = JSON.parse(result); console.log(typeof result); 
                this.setState({
                    assignments: result
