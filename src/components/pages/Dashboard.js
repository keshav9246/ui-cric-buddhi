...
class Dashboard extends Component {
  ...
  getAllUsers = () => {
    ...
    var requestOptions = {
      ...
      fetch("https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/allUsers", requestOptions)
...
getCurrentUser =  ()=> {
  ...
  getFantasyPointsTable = async () => {
    ...
    //   fetch(proxyurl+"https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/fantasyPointsTable", requestOptions)
    //     .then(response => response.text())
    //     .then(result => this.setState({fantasyPointsTable: result}))
    //     .catch(error => console.log('error', error));

        let response = await fetch("https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/fantasyPointsTable", requestOptions);
        let result = await response.json();
  ...
  getPredictionPointsTable = async () => {
    ...
    //   fetch(proxyurl+"https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/predictionPointsTable", requestOptions)
    //     .then(response => response.text())
    //     .then(result => this.setState({predictionPointsTable: result}))
    //     .catch(error => console.log('error', error));

        let response = await fetch("https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/predictionPointsTable", requestOptions);
        let result = await response.json();
        result.map((element,index) => {
            console.log(element.userName, this.state.currentUserName)
            if(this.state.currentUserName == 'Lakhan' && this.state.currentUserName.split(" ")[0] == 'Harsh'){
