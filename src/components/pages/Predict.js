...
class Predict extends Component {
    ...
    //     const url = "https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/gamesToday";
...
myHeaders.append("Access-Control-Allow-Origin", "*");
    ...
    handleVotes = (gameNum, userId, predictedTeam) => {
      ...
      const data = { 
        ...
        const proxyurl = "https://cors-anywhere.herokuapp.com/";
         let url = "https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/submitPrediction";
         fetch(url, {
          method: 'POST', // or 'PUT'
          headers: {
