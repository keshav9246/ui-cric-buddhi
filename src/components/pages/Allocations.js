  ...
  state = {
    ...
    getAllocations = () => {
        var requestOptions = {
          ...
          fetch( "https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/allocations", requestOptions)
    ...
    getAllocationsByGame = (game) => {
        var requestOptions = {
          ...
          fetch( "https://ws-crickshetra-d4cea40c595e.herokuapp.com/v1/iplt20/allocationsByGame?gameNum="+game, requestOptions)
            .then(response => response.text())
            .then(result => {result = JSON.parse(result); console.log(typeof result); 
                this.setState({
                allocations: result
