...
constructor(props){
    ...
    getPlayers = ()=> {
        ...
        fetch(`https://18.219.229.84/v1/iplt20/getPlayers?gameNum=${this.state.selectedGame}`, requestOptions)
    ...
    submitPlaying11=()=>{
        ...
        var requestOptions = {
          ...
          fetch(`https://18.219.229.84/v1/iplt20/submitPlaying11`, requestOptions)
            .then(response => response.text())
