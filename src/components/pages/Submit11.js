...
constructor(props){
    ...
    getPlayers = ()=> {
        ...
        fetch(`https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/getPlayers?gameNum=${this.state.selectedGame}`, requestOptions)
    ...
    submitPlaying11=()=>{
        ...
        var requestOptions = {
          ...
          fetch(`https://crickshetra-api-706bf9ac0811.herokuapp.com/v1/iplt20/submitPlaying11`, requestOptions)
            .then(response => response.text())
